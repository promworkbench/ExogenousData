...
public class GuardPrecisionAxiom9 {
	
	Path axiomDir = Paths.get(
			"tests","src-test","resource", "axioms", "axiom 9"
	);
	
	Path modelPatha = Paths.get(axiomDir.toString(), "ax9_model_1.pnml");
	Path modelPathb = Paths.get(axiomDir.toString(), "ax9_model_2.pnml");
