package org.processmining.qut.exogenousdata.steps.slicing.data;
...
//	public enums
	...
	public enum Scaling {
		...
		weekly(1000.0 * 60.0 * 60.0 * 24 * 7),
		fortnightly(1000.0 * 60.0 * 60.0 * 24 * 7 * 2),
		monthly(1000.0 * 60.0 * 60.0 * 24 * 7 * 4),
		quarterly(1000.0 * 60.0 * 60.0 * 24 * 7 * 4 * 3);
