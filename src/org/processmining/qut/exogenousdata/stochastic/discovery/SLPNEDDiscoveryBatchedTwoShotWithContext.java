...
public class SLPNEDDiscoveryBatchedTwoShotWithContext extends SLPNEDDiscoveryBatchedTwoShot {
	
	protected UIPluginContext context = null;
	
	public SLPNEDDiscoveryBatchedTwoShotWithContext() {
		super();
	}
...
//			Solver.PROG = null;
	...
	public SLPNEDDiscoveryBatchedTwoShotWithContext(UIPluginContext context) {
		super();
