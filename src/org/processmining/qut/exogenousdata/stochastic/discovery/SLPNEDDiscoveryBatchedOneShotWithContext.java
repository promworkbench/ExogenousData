...
public class SLPNEDDiscoveryBatchedOneShotWithContext extends SLPNEDDiscoveryBatchedOneShot {
	
	protected UIPluginContext context = null;
	
	public SLPNEDDiscoveryBatchedOneShotWithContext() {
		super();
	}
...
//			Solver.PROG = null;
	...
	public SLPNEDDiscoveryBatchedOneShotWithContext(UIPluginContext context) {
		super();
